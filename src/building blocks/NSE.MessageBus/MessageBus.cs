...
namespace NSE.MessageBus
{
    public class MessageBus : IMessageBus
    {
        ...
        public async Task<IDisposable> RespondAsync<TRequest, TResponse>(Func<TRequest, Task<TResponse>> responder) where TRequest : IntegrationEvent where TResponse : ResponseMessage
        {
            TryConnect();
        ...
        private void TryConnect()
        {
            ...
            var policy = Policy
                .Handle<EasyNetQException>() // Erro do EasyNetQ
                .Or<BrokerUnreachableException>() // Erro do RabbitMQ
