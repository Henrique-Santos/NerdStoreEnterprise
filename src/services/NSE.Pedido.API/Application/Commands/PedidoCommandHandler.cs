...
using NSE.Pedido.API.Application.Dtos;
...
namespace NSE.Pedido.API.Application.Commands
{
    public class PedidoCommandHandler : CommandHandler, IRequestHandler<AdicionarPedidoCommand, ValidationResult>
    {
        ...
        public async Task<ValidationResult> Handle(AdicionarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            // Processar pagamento
            if (!await ProcessarPagamento(message, pedido)) return ValidationResult;
        ...
        private Domain.Pedidos.Pedido MapearPedido(AdicionarPedidoCommand message)
        {
            ...
            var pedido = new Domain.Pedidos.Pedido(message.ClienteId, message.ValorTotal, message.PedidoItems.Select(PedidoItemDTO.ParaPedidoItem).ToList(), message.VoucherUtilizado, message.Desconto);
        ...
        public async Task<bool> ProcessarPagamento(AdicionarPedidoCommand message, Domain.Pedidos.Pedido pedido)
        {
